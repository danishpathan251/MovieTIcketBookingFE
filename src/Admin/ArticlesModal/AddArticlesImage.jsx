...
function AddArticlesImage({closeModal2, responseId}) {
    ...
    const handleFileChange = (e) => {
      ...
      const handleSubmit = () =>{
        ...
        axios.put(`${process.env.REACT_APP_BASE_URL}/admin/updateArticleImage/${responseId}`,formData).then((res) =>{
  ...
  <span className="close"onClick={closeModal2}>&times; &nbsp;</span>
    <div className="modal-header pt-5 mx-3 border-bottom"><h2>News Image Upload</h2></div>
    ...
    <div className="row mt-3 pt-3 px-3">
                                 ...
                                 <div className="p-3"><label className="labels">ID: {responseId}</label></div>
...
export default AddArticlesImage;